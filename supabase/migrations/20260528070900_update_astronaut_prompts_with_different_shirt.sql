      ...
      case
        ...
        when (slide_item.slide->>'order')::int = 2
          then jsonb_set(
            ...
            '{prompt_recipe}',
            to_jsonb(
              'Show the same exact two people ({relationship}) from the previous photo, now both {age_step} years older than before, doing this activity: {scene_2} ({action_2}). Because this is a completely new time, each person should be wearing a completely different shirt. Keep amateur realism, era consistency, natural lighting, and candid imperfections.'::text
            ),
            true
          )
        when (slide_item.slide->>'order')::int = 3
          then jsonb_set(
            ...
            '{prompt_recipe}',
            to_jsonb(
              'Show the same exact two people ({relationship}) from the previous photo, now both {age_step} years older than before, doing this activity: {scene_3} ({action_3}). Because this is a completely new time, each person should be wearing a completely different shirt. Keep amateur realism, era consistency, natural lighting, and candid imperfections.'::text
            ),
            true
          )
        when (slide_item.slide->>'order')::int = 4
          then jsonb_set(
            ...
            '{prompt_recipe}',
            to_jsonb(
              'Show the same exact two people ({relationship}) from the previous photo, now both {age_step} years older than before, doing this activity: {scene_4} ({action_4}). Because this is a completely new time, each person should be wearing a completely different shirt. Keep amateur realism, era consistency, natural lighting, and candid imperfections.'::text
            ),
            true
          )
